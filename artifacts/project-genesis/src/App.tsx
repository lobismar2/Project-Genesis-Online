...
export const ACHIEVEMENTS = [['warrior', 'Um Verdadeiro Guerreiro', 'Encontre uma arma nova.', 'W'], ['wild', 'Rumo ao Desconhecido', 'Saia da vila inicial.', 'F'], ['rats', 'Ratos Furiosos', 'Mate 10 ratos.', 'R'], ['talk', 'Bate-papo', 'Fale com um NPC.', 'D'], ['loot', 'Grande Saque', 'Consiga uma armadura nova.', 'A'], ['cave', 'Subterrâneo', 'Explore uma caverna.', 'C'], ['shore', 'No Fim do Mundo', 'Alcance a praia ao sul.', 'S'], ['escape', 'Nhá! Nhá!', 'Fuja de um inimigo.', 'E'], ['graveyard', 'Saqueador de Tumbas', 'Encontre o cemitério.', 'G'], ['skulls', 'Colecionador de Caveiras', 'Mate 10 esqueletos.', 'K'], ['ninja', 'Saque Ninja', 'Pegue um item sem lutar.', 'N'], ['desert', 'Terra de Ninguém', 'Atravesse o deserto.', 'T'], ['hunter', 'Caçador', 'Mate 50 inimigos.', 'H'], ['alive', 'Ainda Vivo', 'Reviva 5 vezes.', '♥'], ['meatshield', 'Escudo de Carne', 'Receba 5000 de dano.', 'M'], ['hotspot', 'Ponto Quente', 'Entre nas montanhas.', '▲'], ['hero', 'Herói', 'Derrote o chefe final.', '♛'], ['foxy', 'Poção Rara', 'Encontre a poção especial.', '◆'], ['science', 'Pela Ciência', 'Entre em um portal.', 'O'], ['nomore', 'Rato! Nunca Mais', 'Mate 50 ratos.', 'X']] as const;
...
export const MISSIONS: Mission[] = [
  ...
  { id: 'forest-goblins', region: 'Floresta', npcId: 'elder', title: 'Tochas na mata', desc: 'Derrote 8 goblins na floresta', goal: 8, reward: '200 XP · 25 moedas', kind: 'kill', target: 'goblin', xp: 200, prerequisite: 'forest-rats' },
  { id: 'forest-ogre', region: 'Floresta', npcId: 'elder', title: 'O que pisa fundo', desc: 'Derrote 3 ogros na floresta', goal: 3, reward: '320 XP · 2 frascos', kind: 'kill', target: 'ogre', xp: 320, prerequisite: 'forest-goblins' },
  { id: 'grave-vigil', region: 'Cemitério', npcId: 'sentry', title: 'Vigília quebrada', desc: 'Derrote 12 espectros no cemitério', goal: 12, reward: '380 XP · 40 moedas', kind: 'kill', target: 'spectre', xp: 380, prerequisite: 'grave-souls' },
  { id: 'cave-armory', region: 'Caverna', npcId: 'smith', title: 'Forja soterrada', desc: 'Consiga uma armadura incomum ou melhor', goal: 1, reward: '240 XP · 30 moedas', kind: 'gear', target: 'uncommon', xp: 240, prerequisite: 'cave-bats' },
  { id: 'ice-crabs', region: 'Geleira', npcId: 'guide', title: 'Cascas sob o gelo', desc: 'Derrote 10 caranguejos na geleira', goal: 10, reward: '420 XP · 45 moedas', kind: 'kill', target: 'crab', xp: 420, prerequisite: 'hub-ice-scout' },
  { id: 'ice-return', region: 'Geleira', npcId: 'guide', title: 'Caminho de volta', desc: 'Use a passagem lateral da Geleira', goal: 1, reward: '260 XP · desbloqueia rota curta', kind: 'zone', target: 'cave', xp: 260, prerequisite: 'ice-crabs' },
  { id: 'volcano-scout', region: 'Montanhas', npcId: 'sentry', title: 'Fumaça na crista', desc: 'Explore a Caldeira Rubra', goal: 1, reward: '300 XP · 35 moedas', kind: 'zone', target: 'volcano', xp: 300, prerequisite: 'ice-return' },
  { id: 'volcano-skeletons', region: 'Montanhas', npcId: 'smith', title: 'Ossos na cinza', desc: 'Derrote 15 esqueletos na caldeira', goal: 15, reward: '520 XP · 60 moedas', kind: 'kill', target: 'skeleton', xp: 520, prerequisite: 'volcano-scout' },
  { id: 'hub-full-circle', region: 'Vila do Limiar', npcId: 'steward', title: 'Volta completa', desc: 'Retorne à Vila do Limiar depois de cruzar a cadeia', goal: 1, reward: '480 XP · título Peregrino', kind: 'zone', target: 'hub', xp: 480, prerequisite: 'volcano-skeletons' },
  { id: 'hub-arsenal', region: 'Vila do Limiar', npcId: 'smith', title: 'Arsenal do Limiar', desc: 'Consiga uma arma rara ou melhor', goal: 1, reward: '560 XP · 80 moedas', kind: 'gear', target: 'rare', xp: 560, prerequisite: 'hub-full-circle' },
